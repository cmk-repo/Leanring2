...
function MainApp() {
  ...
  //const [messagingAtomCount, setMessagingAtomCount] = useSetRecoilState(messagingAtom); // to add button to update
...
function Buttonupdate() {
  const setMessagingAtomCount = useSetRecoilState(messagingAtom); // to add button to update
